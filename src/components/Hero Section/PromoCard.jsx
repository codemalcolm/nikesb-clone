...
const PromoCard = (props) => {
  return (
    <>
      {/* MOBILE */}
      <a href="https://www.nike.com/t/sb-react-leo-skate-shoes-fWzQ6w/DX4361-100" className="sm:hidden">
      ...
      {/* DESKTOP  */}
      <a href="https://www.nikesb.com/assets/uploads/hero/NIKESB_SLP_P1.jpg" className="lg:block max-sm:hidden">
          <img src="https://www.nikesb.com/assets/uploads/hero/NIKESB_SLP_P1.jpg" alt="promo-poster"></img>
          <div className="my-8 flex-column items-center justify-center">
              <h3 className="font-semibold text-center">Introducing {props.productName}</h3>
              <h2 className="text-promo-size flex flex-wrap justify-center font-fira-sans">BAKED TO<span className="pl-2.5">PERFECTION.</span></h2>
              <div className="flex justify-center mt-4">
